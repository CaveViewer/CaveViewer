...
class StepperControl:
    ...
    def _rebuild_render_cache(
        ...
        def draw_button(rect, symbol):
            ...
            bg = (0.30, 0.34, 0.40, 0.82) if at_limit else (0.36, 0.41, 0.50, 0.96)
            border_color = (0.68, 0.72, 0.78, 0.85) if at_limit else (0.55, 0.70, 0.95, 1.0)
            text_color = (0.68, 0.74, 0.84, 1.0) if at_limit else (0.95, 0.97, 1.0, 1.0)
            ...
            add_text(symbol, cx - sym_w / 2.0 - sbx0, cy - sym_h / 2.0 - sby0, symbol_size, text_color)
        ...
        add_quad_px(vx0, vy0, vx1, vy1, (0.24, 0.27, 0.34, 0.94))
        vborder = 2.0
        vborder_color = (0.62, 0.76, 0.97, 0.92)
