...
class ColorPicker:
    ...
    def render(self, window_size: tuple[int, int]) -> None:
        ...
        w, h = window_size
        add_quad_px(0, 0, w, h, (0.03, 0.05, 0.08, 0.55))

        add_quad_px(px0, py0, px1, py1, (0.18, 0.21, 0.27, 0.95))
        border = 2.0
        ...
        for channel in range(3):
            ...
            add_quad_px(tx0, ty0, tx1, ty1, (0.28, 0.32, 0.40, 0.88))
            t = self.values[channel] / 255.0
            fill_x = tx0 + t * (tx1 - tx0)
            add_quad_px(tx0, ty0, fill_x, ty1, accent)

            hx0, hy0, hx1, hy1 = self._handle_rect_px(channel, window_size)
            add_quad_px(hx0, hy0, hx1, hy1, (0.90, 0.94, 1.0, 1.0))
            hborder = 1.5
        ...
        swatch_border = 1.5
        add_quad_px(swatch_x0, swatch_y0, swatch_x1, swatch_y0 + swatch_border, (0.55, 0.70, 0.95, 1.0))
