...
# export CAVEVIEWER_UPDATE_MANIFEST_URL="https://raw.githubusercontent.com/innerspace-explorer/CaveViewerMac/main/updates/macos/stable.json"
# Or set a repo and let the app derive:
export CAVEVIEWER_GITHUB_REPO="innerspace-explorer/CaveViewerMac"
