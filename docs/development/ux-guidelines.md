...
- Use that same geometry for launch, viewer import and streaming, repositioning,
  ...
  Initial launch places its live product wordmark and bar over a subdued cave
  mesh with a darker center. Map-loading states retain their solid background;
  startup artwork belongs only to the initial launch surface.
