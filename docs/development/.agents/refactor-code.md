...
| 13 | Architecture document authority | `refactor/architecture-document-authority` | Implemented locally — review pending | Enforce after merge | `c8cd5aa` | [#231](https://github.com/CaveViewer/CaveViewer/issues/231) | Architecture now contains the authority map; runtime-setting mechanics have a focused canonical page while source setup retains operational commands, generated tables, and troubleshooting. |
...
| 18 | Source-setup operational reference split | `refactor/architecture-document-authority` | Implemented locally — combined with 13 | Enforce after merge | `c8cd5aa` | [#270](https://github.com/CaveViewer/CaveViewer/issues/270) | The focused runtime-configuration page owns resolution mechanics; source setup explicitly remains the operational command, variable, storage, and troubleshooting reference. |
