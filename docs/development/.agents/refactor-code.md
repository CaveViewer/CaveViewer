...
| 10 | Map Library catalog and download workflows | `refactor/map-library-catalog-download` | Implemented locally — review pending | Enforce after merge | `b7daf02` | [#228](https://github.com/CaveViewer/CaveViewer/issues/228) | Focused catalog and download lifecycle owners manage worker startup, queues, polling, cancellation, inhibition, terminal delivery, and close cleanup; Tk rendering remains in the coordinator. |
